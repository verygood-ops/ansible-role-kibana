# python import_dashboards.py http://localhost:9200 < file.json
 
import sys, httplib, urllib2, json
 
if len(sys.argv) < 2 :
  print("usage :  python import_dashboards.py http://localhost:9200 < file.json")
  exit()
...
for dashboard in dashboards:
  try:
    print("Import dashboard id: %s" % dashboard["_id"])
